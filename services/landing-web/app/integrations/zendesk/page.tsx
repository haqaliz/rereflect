...
import { ArrowRight, Clock, FileText, TrendingUp, Target, Settings as SettingsIcon, Sparkles, X } from 'lucide-react';
          ...
          <div className="cta-content relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-chart-5 to-accent p-12 md:p-16 lg:p-20">
            ...
            <div className="relative text-center">
              ...
              <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                Sign up for free and we&apos;ll notify you when the Zendesk integration launches.
              </p>
