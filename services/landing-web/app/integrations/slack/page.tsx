...
import { ArrowRight, ChevronRight, ChevronDown, Hash, Zap, Bell, Search, MessageSquare, Tags, Rocket, Sparkles, Settings as SettingsIcon, Github } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <div className="hero-badge inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
              <SlackIcon size={16} />
              <span className="text-sm font-semibold text-primary">Slack Integration</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {integration.features.map((feature, index) => {
              const IconComponent = featureIconMap[feature.icon] || Hash;
              const gradients = [
          ...
          <div className="cta-content relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-chart-5 to-accent p-12 md:p-16 lg:p-20">
            ...
            <div className="relative text-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                Self-host and connect Slack.
              </h2>
              <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                Deploy Rereflect on your own infrastructure and start analyzing Slack feedback in minutes.
              </p>
