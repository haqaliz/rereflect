...
import { ArrowRight, ChevronRight, ChevronDown, KeyRound, FileText, Tags, RefreshCw, Shield, Rocket, Sparkles, Settings as SettingsIcon, Layers, Github } from 'lucide-react';
...
const integration = getIntegration('asana');
...
export default function AsanaIntegrationPage() {
  ...
  return (
    <div ref={heroRef} className="min-h-screen bg-background overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <div className="hero-badge inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
              <AsanaIcon size={16} />
              <span className="text-sm font-semibold text-primary">Asana Integration</span>
            </div>
            ...
            <p className="hero-subtitle text-lg md:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="hero-cta flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <button className="group px-8 py-4 text-base font-semibold text-foreground bg-background border-2 border-border rounded-2xl transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:scale-[1.02]">
      ...
      <section id="how-it-works" ref={stepsRef} className="relative z-10 py-24 md:py-32 border-y border-border bg-card/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {integration.howItWorks.map((step, index) => (
              <div key={index} className="step-card text-center">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-chart-5 flex items-center justify-center text-white font-bold text-lg mx-auto mb-4 shadow-lg shadow-primary/25">
                  {step.step}
                </div>
      ...
      <section ref={featuresRef} className="relative z-10 py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {integration.features.map((feature, index) => {
              const IconComponent = featureIconMap[feature.icon] || Layers;
              const gradients = [
      ...
      {/* FAQ Section */}
      <section className="relative z-10 py-24 md:py-32 border-t border-border bg-card/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            {integration.faqs.map((faq, index) => (
              <div key={index} className="border border-border rounded-2xl overflow-hidden bg-card">
                <button
                  ...
                  className="w-full px-6 py-4 flex justify-between items-center cursor-pointer hover:bg-muted/50 transition-colors"
                >
          ...
          <div className="cta-content relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-chart-5 to-accent p-12 md:p-16 lg:p-20">
            ...
            <div className="relative text-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
                Self-host and connect Asana.
              </h2>
              <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                Deploy Rereflect on your own infrastructure and push customer feedback straight into Asana tasks.
              </p>
