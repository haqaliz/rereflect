...
import { ArrowRight, Clock, Users, DollarSign, TrendingUp, BarChart3, Sparkles, X, Github } from 'lucide-react';
...
export default function HubSpotIntegrationPage() {
  ...
  const featureIconMap: Record<string, React.ReactNode> = {
    ...
    BarChart3: <BarChart3 className="w-7 h-7 text-white" />,
  };
          ...
          <div className="cta-content relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-chart-5 to-accent p-12 md:p-16 lg:p-20">
            ...
            <div className="relative text-center">
              ...
              <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                Star the repo or open an issue to track progress on the HubSpot integration.
              </p>
