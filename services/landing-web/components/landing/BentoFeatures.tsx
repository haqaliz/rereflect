...
const smallCards: {
  ...
  },
  {
    ...
    description:
      'API keys with read, ingest, and write scopes — read endpoints, feedback ingestion, single and bulk feedback updates (status, tags, urgency, corrections), custom-category management, webhooks, and OpenAPI docs. Build on top of your own feedback data.',
    animation: 'spin',
  },
];
