...
No I/O, no DB, no FastAPI. This module is a verbatim copy of
services/backend-api/src/services/zendesk_status_core.py; these tests must
never import anything beyond the module under test.
"""
import pytest
