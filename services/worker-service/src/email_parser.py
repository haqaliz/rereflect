...
NOTE: This is a copy of services/backend-api/src/services/email_parser.py
kept in sync manually. The worker-service needs its own copy because
cross-service imports are fragile.
"""
