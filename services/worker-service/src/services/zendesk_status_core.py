...
It is a verbatim copy of
services/backend-api/src/services/zendesk_status_core.py (worker cannot
import backend-api), so it must remain pure Python with zero external
dependencies beyond the standard library and status_sync_core.VALID_STATUSES.
"""
