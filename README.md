...
| 🔌 **Sources & integrations** | **Inbound:** CSV import, email, webhooks and Slack, plus support desks (Intercom, Zendesk). **Issue trackers:** Jira, Linear and Asana. **CRM:** HubSpot and Salesforce. **Outbound:** alerts and digests via Slack and Discord, and customer outreach via email (BYO-key Resend, opt-out honored). |
